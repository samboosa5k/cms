...
if (isset($_GET['user_id'])) {
    ...
    if (isset($_POST['edit_user'])) {
        ...
        if (!$edit_user_query) {
            ...
            echo "<div class='alert alert-success' role='alert'>User edit succeeded!: " . "<a href='./users.php'>View users</a></div>";
        }
    }
}
?>
...
<form action="" method="post" enctype="multipart/form-data" class="">
    <div class="form-group">
        ...
        <br>
        <input autocomplete="off" type="password" name="user_password" value="<?php echo $user_password; ?>" class="form-control">
        <br>
    </div>
