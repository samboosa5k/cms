    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="row" id="like-parent">
                <p class="pull-right"><span class="glyphicon glyphicon-fire"></span><a href="#" class="like"> Like </a></p>
            </div>

            <div class="row" id="unlike-parent">
                <p class="pull-right"><span class="glyphicon glyphicon-chevron-down"></span><a href="#" class="unlike"> Unlike </a></p>
            </div>

            <div class="row" id="">
                <p class="pull-right">Likes: <span>69</span></p>
            </div>
 ...
 -->
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            /*  var likeParent = document.getElementById("like-parent");
            var unlikeParent = document.getElementById("unlike-parent");

            if (alreadyLiked) {
                likeParent.classList.add("hidden");
            } else {
                unlikeParent.classList.add("hidden");
            }
 */
            //  LIKING
